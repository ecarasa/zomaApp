<div class="account-hub-content" id="pistascentro" style="margin-top: 0px">
        <!-- SECTION HEADER -->
        ...
        <div class="chat-widget-wrap" id="msjEnviados" >
          ...
          <button class="button primary" onclick="MostrarDivUnico('DivEnviarPista')">Enviar Pista</button>
